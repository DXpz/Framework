        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="d-inline">PHP CRUD</h3>
                    <a href="<?= base_url('alumnos/create') ?>" class="btn btn-primary float-right">Agregar alumno</a>
                </div>
                <div class="card-body">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="<?= base_url('alumnos/delete/' . $alumno['id']) ?>" 
